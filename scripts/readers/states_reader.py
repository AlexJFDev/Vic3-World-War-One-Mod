...
NEW_STATES_PATH = os.path.join('game', 'files', 'common', 'history', 'states', '00_states.txt')
...
def convert_states(states_root: ClausewitzRoot):
    states = {}
...
if __name__ == '__main__':
    ...
    new_states = convert_states(new_states_root)
